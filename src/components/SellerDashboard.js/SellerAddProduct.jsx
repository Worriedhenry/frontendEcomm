  ...
  const renderBoxes = () => {
    return boxes.map((box, index) => (
      ...
      >
        ...
        {<div>
          <Button style={{display:Files[index] ? "inline":"none"}} color="success" variant="contained" size="small" onClick={() => handleUpload(index)}>Upload</Button>
          <Button  color="error" variant="contained" size="small" onClick={() => handleDelete(index)}>Delete</Button>
        </div>}
      </div>
    ));
  };
