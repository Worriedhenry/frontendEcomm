    ...
    <Box sx={{ display: 'flex', flexWrap: 'wrap' ,paddingTop:"30px" }}>
      ...
      <FormControl fullWidth sx={{ m: 1 }}>
        ...
        <div>
            ...
            <Button onClick={handleSelect}  variant="contained" style={{width:"18vh" ,height:"8vh" ,margin:"10px", background:isDisable && "#878787",textTransform:"none"}} >All Categories</Button>
            <Button onClick={handleSelect} variant="contained" style={{width:"18vh" ,height:"8vh" ,margin:"10px" ,background:!isDisable && "#878787",textTransform:"none"}} >Only Books</Button>
        </div>
